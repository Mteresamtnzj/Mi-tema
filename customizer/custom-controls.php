...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Checkbox_Custom_Control extends WP_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'custom_controls', get_template_directory_uri() . '/customizer/js/custom-controls.js', array( 'jquery' ), $theme_version, true );
			wp_enqueue_style( 'custom_controls_css', get_template_directory_uri() . '/customizer/css/custom-controls.css' );
		}
		/**
		 * Control method
		 *
	...
	class Slider_Control extends WP_Customize_Control {
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'custom_controls', get_template_directory_uri() . '/customizer/js/custom-controls.js', array( 'jquery', 'jquery-ui-slider' ), $theme_version, true );
			wp_enqueue_style( 'custom_controls_css', get_template_directory_uri() . '/customizer/css/custom-controls.css' );
		}
		/**
		 * Control method
